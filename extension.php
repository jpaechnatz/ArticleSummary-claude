...
class ArticleSummaryExtension extends Minz_Extension
{
  ...
  public function init()
  {
    ...
    // Register the summarize action handler
    $this->registerTransitional('summarize');
  ...
  public function addSummaryButton($entry)
  {
    ...
    error_log("ArticleSummary: Generated URL: " . $url_summary);
  ...
  public function handleSummarizeAction()
  {
    // Enable error logging FIRST
    error_log("=== ArticleSummary: handleSummarizeAction called ===");
